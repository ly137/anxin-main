...
final class MapCanvasOverlayRenderer {
    ...
    private static final Color SELECTION_ACCENT = new Color(37, 99, 235);    // #2563EB
    private static final Color EDGE_SELECTION = new Color(249, 115, 22);     // #F97316
    private static final Color GUIDE_ACCENT = new Color(59, 130, 246, 190);  // #3B82F6 alpha
