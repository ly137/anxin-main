...
final class MapCanvasRouteRenderer {
    ...
    private void drawRouteStepBadges(
        ...
        for (RouteVisualizationDto.Segment segment : routeVisualization.getSegments()) {
            ...
            Color fillColor = focused ? routeVisualization.getFocusedBadgeFillColor() : new Color(248, 250, 252);
            Color borderColor = focused ? Color.WHITE : new Color(100, 116, 139);

            g2.setColor(new Color(15, 23, 42, focused ? 40 : 26));
    ...
    private void drawMarker(Graphics2D g2, Point2D.Double point, String text, Color fillColor) {
        ...
        g2.setColor(new Color(15, 23, 42, 32));
