...
final class MapCanvasBaseSceneRenderer {
    ...
    private static final Color GRID_MINOR = new Color(241, 245, 249);  // #F1F5F9
    private static final Color GRID_MAJOR = new Color(226, 232, 240);  // #E2E8F0
    private static final Color FORBIDDEN_ROAD = new Color(239, 68, 68); // #EF4444
