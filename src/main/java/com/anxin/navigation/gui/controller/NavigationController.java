...
public class NavigationController {
    ...
    public PathResult queryPath(String startId, String endId, double speedMetersPerMinute) {
        return navigationService.navigate(graph, startId, endId, speedMetersPerMinute);
    }

    public NavigationVisualResult queryPathVisual(String startId, String endId) {
        return queryPathVisual(startId, endId, NavigationService.WALKING_SPEED_METERS_PER_MIN);
    }

    public NavigationVisualResult queryPathVisual(String startId, String endId, double speedMetersPerMinute) {
        PathResult pathResult = navigationService.navigate(graph, startId, endId, speedMetersPerMinute);
    ...
    public String format(PathResult pathResult, String transportLabel) {
        return pathFormatter.format(pathResult, transportLabel);
    }
